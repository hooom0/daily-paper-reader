...
title_zh: 文本到图像扩散模型中的概念遗忘认证
authors: "Mansi, Luca Marzari, Francesco Leofante"
date: 2026-09-10
pdf: "https://arxiv.org/pdf/2609.12163v1"
tags: ["query:image-gen"]
score: 6.0
evidence: 文本到图像扩散模型中的概念遗忘认证
tldr: "现有T2I概念遗忘评估多依赖自动化对抗提示搜索得到的攻击成功率，仅覆盖有限查询，无法量化更广提示空间的残留泄漏。为此，本文提出认证框架，将统计认证与概念相关嵌入方向的最坏情况分析结合，在用户指定置信水平下给出泄漏概率的显式上界。在NSFW内容、艺术风格和名人身份三类概念及六种先进遗忘方法上，认证泄漏上界一致高于标准攻击成功率16.2%。这表明基于攻击的评估会显著低估残留风险，认证应成为T2I概念遗忘可靠审计的必要补充。"
source: arxiv
selection_source: fresh_fetch
figures_json: "[{\"url\": \"assets/figures/arxiv/2609.12163v1/fig-001.webp\", \"caption\": \"\", \"page\": 1, \"index\": 1, \"width\": 3204, \"height\": 936}, {\"url\": \"assets/figures/arxiv/2609.12163v1/fig-002.webp\", \"caption\": \"\", \"page\": 1, \"index\": 2, \"width\": 512, \"height\": 512}, {\"url\": \"assets/figures/arxiv/2609.12163v1/fig-003.webp\", \"caption\": \"\", \"page\": 9, \"index\": 3, \"width\": 1350, \"height\": 900}, {\"url\": \"assets/figures/arxiv/2609.12163v1/fig-004.webp\", \"caption\": \"\", \"page\": 13, \"index\": 4, \"width\": 3636, \"height\": 742}, {\"url\": \"assets/figures/arxiv/2609.12163v1/fig-005.webp\", \"caption\": \"\", \"page\": 13, \"index\": 5, \"width\": 3636, \"height\": 742}]"
motivation: 现有评估仅用有限对抗查询的攻击成功率，未量化更广提示空间的残留泄漏，易高估遗忘效果并低估安全风险。
method: 提出认证框架，结合统计认证与概念相关嵌入方向的最坏情况分析，在指定置信水平下给出泄漏概率显式上界。
result: "在NSFW、艺术风格、名人身份三类概念和六种先进遗忘方法上，认证泄漏上界比攻击成功率平均高16.2%。"
conclusion: 证明攻击式评估会显著低估残留泄漏，认证应作为T2I概念遗忘可靠审计的必要补充。
---

## 摘要
现有对文本到图像（T2I）扩散模型中概念遗忘的评估，主要依赖于通过自动化对抗提示搜索获得的攻击成功率。然而，这些指标仅能在有限查询集上提供经验证据，对于更广泛的提示空间中的残余泄漏，在很大程度上仍未量化。这一局限可能导致高估遗忘有效性并低估安全风险。为弥补这一空白，我们提出了一种新的T2I概念遗忘认证框架，可对残余概念泄漏提供有界误差的高置信度保证。我们的方法将统计认证与沿概念相关嵌入方向的最坏情况分析相结合，在用户指定的置信水平下推导出泄漏概率的显式上界。我们在三大概念类别，即NSFW内容、艺术风格和名人身份，以及六种最先进的遗忘方法上评估了我们的框架。经认证的泄漏上界始终比标准攻击成功率高16.2%，揭示了现有评估协议所遗漏的大量残余风险。至关重要的是，我们的结果表明，基于经验攻击的评估可能显著低估残余泄漏，并确立了认证作为可靠审计T2I扩散模型中概念遗忘的必要补充。
